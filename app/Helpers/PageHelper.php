...
if (!function_exists('page_title_from_route')) {
    function page_title_from_route(): string
    {
        ...
        $custom = [
            ...
            'admin.branches.index'     => 'Estructura — Sucursales',
            'admin.branches.create'    => 'Nueva Sucursal',
            'admin.branches.edit'      => 'Editar Sucursal',
            'admin.companies.index'    => 'Empresas y Sucursales',
            'admin.companies.create'   => 'Nueva Empresa',
            'admin.companies.edit'     => 'Editar Empresa',

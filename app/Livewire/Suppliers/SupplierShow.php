...
class SupplierShow extends Component
{
    ...
    public function render()
    {
        ...
        $movements = $this->supplier->movements()->with('product', 'user')->orderBy('created_at', 'desc')->paginate(10, ['*'], 'movementsPage');

        return view('livewire.suppliers.supplier-show', compact('purchases', 'movements'))->layout('components.layouts.app');
    }
}

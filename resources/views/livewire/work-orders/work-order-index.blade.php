                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center justify-between text-sm bg-gray-50 rounded-lg px-3 py-2">
                            ...
                            <span class="font-medium text-gray-700">{{ $currentStepIndex + 1 }} de {{ count($selectedOrders) }}</span>
                            <button wire:click="goToStep({{ $currentStepIndex + 1 }})"
                        ...
                        <div class="bg-blue-50 rounded-lg px-3 py-2 space-y-0.5">
                            <div class="flex items-center justify-between">
                                <span class="font-mono font-bold text-xs text-blue-700">{{ $stepOt->code ?? '—' }}</span>
                                <span class="text-xs text-blue-500">{{ $stepOt->scheduled_date? $stepOt->scheduled_date->format('d/m/Y') : '' }}</span>
                            </div>

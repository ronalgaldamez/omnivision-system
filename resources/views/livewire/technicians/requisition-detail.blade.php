                ...
                <x-ui.card overflow="visible">
                            ...
                            <div class="bg-gray-50 rounded-lg border border-gray-200 p-4 space-y-2">
                                ...
                                <div class="grid grid-cols-2 gap-3 mt-2">
                                    <div>
                                        ...
                                        <x-ui.input type="number" wire:model="editingMaterials.{{ $index }}.quantity_used" min="0" />
                                    </div>
                                    <div>
                                        <label class="block text-xs text-gray-500 mb-1">Motivo del ajuste</label>
                                        <x-ui.input type="text" wire:model="editingMaterials.{{ $index }}.motivo" placeholder="¿Por qué se ajusta?" />
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <x-slot:footer>
                        <div class="flex justify-end gap-3">
                            ...
                            <x-ui.button variant="primary" icon="save" wire:click="saveEditModal">Guardar cambios</x-ui.button>
                        </div>
                    </x-slot:footer>
                </x-ui.card>
            </div>

            ...
            <nav class="flex gap-1" role="tablist">
                @php
                    ...
                    $tabCounts = [
                        ...
                        'completed' => (clone $baseQuery)->whereNotNull('contracts_ended_at')->count(),
                    ];
                @endphp
                            ...
                            <tr class="hover:bg-gray-50/80 transition">
                                ...
                                @if($activeTab === 'pending')
                                    <td class="px-4 py-3 text-center font-mono text-sm text-amber-600 font-medium">
                                        @if($ticket->contracts_escalated_at)
                                            @php $wait = $ticket->contracts_escalated_at->diffInSeconds(now()); @endphp
                                ...
                                @elseif($activeTab === 'in_progress')
                                    <td class="px-4 py-3 text-center font-mono text-sm text-blue-600 font-medium">
                                        @if($ticket->contracts_started_at)
                                            @php $active = $ticket->contracts_started_at->diffInSeconds(now()); @endphp

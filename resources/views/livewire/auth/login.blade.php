    ...
    <div class="w-full max-w-sm">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            ...
            <div class="px-8 pt-8 pb-6 text-center border-b border-gray-100">
                ...
                <h1 class="text-lg font-semibold text-gray-800">Acceso al sistema</h1>
            ...
            <div class="px-8 py-7">
                <form wire:submit="login" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="w-full pl-9 pr-3 py-2.5 text-sm rounded-lg border border-gray-200 bg-gray-50 text-gray-800 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 focus:bg-white transition"
                            >
                        </div>
                        @error('email')
                    ...
                    <div>
                        ...
                        >
                            ...
                            <input
                                ...
                                required
                                placeholder="••••••••"
                                class="w-full pl-9 pr-10 py-2.5 text-sm rounded-lg border border-gray-200 bg-gray-50 text-gray-800 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 focus:bg-white transition"
                            >
                            <button
                                type="button"
                                @click="show = !show"
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input
                                type="checkbox"
                                wire:model="remember"
                                class="w-3.5 h-3.5 rounded border-gray-300 text-blue-600 focus:ring-blue-500/20 focus:ring-2"
                            >
                            <span class="text-xs text-gray-500">Recordarme</span>
                        </label>
                        <a href="#" class="text-xs text-blue-500 hover:text-blue-700 font-medium transition">
                    ...
                    <button
                        type="submit"
                        class="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 active:scale-[0.98] text-white text-sm font-medium py-2.5 px-4 rounded-lg transition duration-150 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <div class="mt-5 pt-5 border-t border-gray-100 text-center">
                    ...
                    <a href="{{ route('register') }}" class="text-xs text-blue-500 hover:text-blue-700 font-medium ml-1 transition">
                        Regístrate
                    </a>
                </div>
                ...
                {{-- Error de sesión --}}
                @if(session('error'))
                    <div class="mt-4 flex items-center gap-2 text-sm text-red-600 bg-red-50 border border-red-100 px-4 py-3 rounded-lg">

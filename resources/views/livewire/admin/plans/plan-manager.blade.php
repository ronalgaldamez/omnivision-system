                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-4 py-3">
                                        ...
                                        @if($rule->inherited_by_count > 0)
                                            <div class="mt-0.5">
                                                <x-ui.badge variant="info">🔽 +{{ $rule->inherited_by_count }} {{ $rule->inherited_by_count === 1 ? 'zona hija' : 'zonas hijas' }}</x-ui.badge>
                                            </div>
                                        @endif
                                    </td>
            ...
            <div class="bg-white rounded-2xl shadow-xl">
                ...
                <div class="px-6 py-5 space-y-4">
                    ...
                    <div>
                        ...
                        {{-- Lista de zonas con árbol o resultados de búsqueda --}}

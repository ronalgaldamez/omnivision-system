    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200/80 overflow-hidden">
        ...
        <div class="p-6">
            <form wire:submit="promptSave" class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <select wire:model.live="municipio_id" {{ empty($availableMunicipios) ? 'disabled' : '' }}
                            class="w-full px-3 py-2.5 rounded-lg border border-gray-300 bg-white shadow-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition text-sm {{ empty($availableMunicipios) ? 'bg-gray-100 text-gray-400' : '' }}">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">Distrito / Localidad</label>
                        <select wire:model.live="distrito_id" {{ empty($availableDistritos) ? 'disabled' : '' }}
                            class="w-full px-3 py-2.5 rounded-lg border border-gray-300 bg-white shadow-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition text-sm {{ empty($availableDistritos) ? 'bg-gray-100 text-gray-400' : '' }}">
                ...
                <label class="inline-flex items-center gap-2 text-sm text-gray-600 cursor-pointer py-1">
                ...
                @if(!$no_price)
                <div class="bg-gray-50/50 rounded-xl border border-gray-200 p-4 space-y-4">

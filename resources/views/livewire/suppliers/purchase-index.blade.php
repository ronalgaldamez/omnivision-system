<div class="max-w-7xl mx-auto">
    <x-ui.card title="Historial de Compras" icon="shopping_cart" subtitle="Facturas y movimientos de adquisición">
        <x-slot:headerActions>
            <x-ui.button variant="primary" icon="add_circle" href="{{ route('purchases.create') }}">Nueva Compra</x-ui.button>
        </x-slot:headerActions>
                    ...
                    <thead>
                        <tr class="bg-gray-50 border-b border-gray-200">
                            <th class="px-4 py-3 text-left text-gray-600 font-medium">
                                <div class="flex items-center gap-1.5"><span class="material-symbols-outlined text-gray-400 text-base">receipt_long</span>Factura</div>
                            </th>
                            <th class="px-4 py-3 text-left text-gray-600 font-medium">
                                <div class="flex items-center gap-1.5"><span class="material-symbols-outlined text-gray-400 text-base">warehouse</span>Proveedor</div>
                            </th>
                            <th class="px-4 py-3 text-center text-gray-600 font-medium">
                                <div class="flex items-center justify-center gap-1.5"><span class="material-symbols-outlined text-gray-400 text-base">calendar_month</span>Fecha</div>
                            </th>

<div class="max-w-2xl mx-auto pb-6">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        {{-- Encabezado --}}
        <div class="px-5 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white flex flex-wrap items-center justify-between gap-3">
            <div>
        ...
        <div class="p-5 space-y-6">
            ...
            <section>
                <div class="flex items-center gap-2 mb-3">
                    <span class="material-symbols-outlined text-blue-600 bg-blue-50 p-1 rounded-lg text-xl">person</span>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div class="flex items-center gap-3 p-3 bg-gray-50/70 rounded-xl border border-gray-100">
                        <span class="material-symbols-outlined text-gray-400 bg-white p-1.5 rounded-lg shadow-sm">person</span>
                        <div class="min-w-0">
                            <p class="text-[10px] text-gray-400 uppercase tracking-wider font-medium">Nombre</p>
                            <p class="text-gray-800 font-medium text-sm truncate">{{ $workOrder->client->name ?? 'No especificado' }}</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-3 p-3 bg-gray-50/70 rounded-xl border border-gray-100">
                        <span class="material-symbols-outlined text-gray-400 bg-white p-1.5 rounded-lg shadow-sm">fingerprint</span>
                        <div class="min-w-0">
                    ...
                    <div class="flex items-center gap-3 p-3 bg-gray-50/70 rounded-xl border border-gray-100">
                        <span class="material-symbols-outlined text-gray-400 bg-white p-1.5 rounded-lg shadow-sm">call</span>
                        <div class="min-w-0">
                    ...
                    <div class="flex items-center gap-3 p-3 bg-gray-50/70 rounded-xl border border-gray-100">
                        <span class="material-symbols-outlined text-gray-400 bg-white p-1.5 rounded-lg shadow-sm">mail</span>
                        <div class="min-w-0">
                    ...
                    <div class="flex items-center gap-3 p-3 bg-gray-50/70 rounded-xl border border-gray-100 sm:col-span-2">
                        <span class="material-symbols-outlined text-gray-400 bg-white p-1.5 rounded-lg shadow-sm">location_on</span>
                        <div class="min-w-0">
                    ...
                    <div class="flex items-center gap-3 p-3 bg-blue-50/50 rounded-xl border border-blue-100 sm:col-span-2">
                        <span class="material-symbols-outlined text-blue-500 bg-white p-1.5 rounded-lg shadow-sm">home_pin</span>
                        <div class="min-w-0">
                    ...
                    <div class="flex items-center gap-3 p-3 bg-gray-50/70 rounded-xl border border-gray-100">
                        <span class="material-symbols-outlined text-gray-400 bg-white p-1.5 rounded-lg shadow-sm">tv</span>
                        <div class="min-w-0">
                    ...
                    <div class="flex items-center gap-3 p-3 bg-gray-50/70 rounded-xl border border-gray-100">
                        <span class="material-symbols-outlined text-gray-400 bg-white p-1.5 rounded-lg shadow-sm">bolt</span>
                        <div class="min-w-0">
                    ...
                    <div class="flex items-center gap-3 p-3 bg-gray-50/70 rounded-xl border border-gray-100 sm:col-span-2">
                        <span class="material-symbols-outlined text-gray-400 bg-white p-1.5 rounded-lg shadow-sm">explore</span>
                        <div class="min-w-0">
            ...
            <section class="bg-gray-50/30 rounded-2xl p-4 border border-gray-100">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-2">
                        <span class="material-symbols-outlined text-orange-600 bg-orange-50 p-1 rounded-lg text-xl">settings</span>
                        <h2 class="text-base font-bold text-gray-800">Datos Técnicos</h2>
                    </div>
                    <div class="flex items-center gap-2">
                        @if($isDraft)
                            <span class="inline-flex items-center gap-1 px-2.5 py-1 bg-amber-100 text-amber-700 rounded-full text-[11px] font-medium">
                ...
                <form wire:submit.prevent="saveTechnicalData" class="space-y-4">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <div class="relative" x-data="{ show: false }">
                                ...
                                <button type="button" x-on:click="show = !show" class="absolute right-2 top-1/2 -translate-y-1/2 p-1 text-gray-400 hover:text-gray-600" tabindex="-1" {{ (!$canEditTech || !$isEditing) ? 'disabled' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="text" wire:model.live="mac" x-data x-on:input="
                    ...
                    <div class="mt-3">
                        ...
                        <div id="map" style="height: 200px; width: 100%;"
                             ...
                             class="rounded-xl border border-gray-200 shadow-inner {{ (!$canEditTech || !$isEditing) ? 'opacity-75 pointer-events-none' : '' }}"></div>
                        @if($canEditTech && $isEditing)
                        <div class="flex gap-2 mt-2">
                            <button type="button" id="getLocationBtn" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-600 text-white text-xs font-medium rounded-lg shadow-sm hover:bg-green-700 transition">
                                <span class="material-symbols-outlined text-sm">my_location</span>Mi ubicación
                            </button>
                            <button type="button" id="clearLocationBtn" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border border-gray-200 text-gray-600 text-xs font-medium rounded-lg hover:bg-gray-50 transition shadow-sm">
                    ...
                    <div class="flex justify-end pt-2">
                        <button type="submit" class="px-5 py-2.5 bg-blue-600 text-white text-sm font-medium rounded-xl shadow-sm hover:bg-blue-700 transition inline-flex items-center gap-2">
            ...
            <section>
                <div class="flex items-center gap-2 mb-3">
                    <span class="material-symbols-outlined text-purple-600 bg-purple-50 p-1 rounded-lg text-xl">confirmation_number</span>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div class="flex items-center gap-3 p-3 bg-gray-50/70 rounded-xl border border-gray-100">
                        <span class="material-symbols-outlined text-gray-400 bg-white p-1.5 rounded-lg shadow-sm">source</span>
                        <div class="min-w-0">
                    ...
                    <div class="flex items-center gap-3 p-3 bg-gray-50/70 rounded-xl border border-gray-100">
                        <span class="material-symbols-outlined text-gray-400 bg-white p-1.5 rounded-lg shadow-sm">flag</span>
                        <div>
                            ...
                            <span class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium
                                ...
                                @endswitch">
                                {{ $workOrder->ticket->priority }} - {{ ['P1'=>'Crítico','P2'=>'Alta','P3'=>'Media','P4'=>'Baja'][$workOrder->ticket->priority] ?? $workOrder->ticket->priority }}
                            </span>
                        </div>
                    </div>
                    @endif
                    @if($workOrder->ticket->description)
                    <div class="flex items-start gap-3 p-3 bg-red-50/50 rounded-xl border border-red-100 sm:col-span-2">
                        <span class="material-symbols-outlined text-red-400 bg-white p-1.5 rounded-lg shadow-sm">description</span>
                        <div>
            ...
            <section>
                <div class="flex items-center gap-2 mb-3">
                    <span class="material-symbols-outlined text-indigo-600 bg-indigo-50 p-1 rounded-lg text-xl">engineering</span>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div class="flex items-center gap-3 p-3 bg-gray-50/70 rounded-xl border border-gray-100">
                        ...
                        <div class="min-w-0">
                            ...
                            @endphp
                            <p class="text-gray-700 text-sm">{{ $creator?->name ?? 'N/A' }}{{ $rol ? ' ('.strtoupper(str_replace('_', ' ', $rol)).')' : '' }}</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-3 p-3 bg-gray-50/70 rounded-xl border border-gray-100">
                        <span class="material-symbols-outlined text-gray-400 bg-white p-1.5 rounded-lg shadow-sm">calendar_month</span>
                        <div class="min-w-0">
                            <p class="text-[10px] text-gray-400 uppercase tracking-wider font-medium">Fecha programada</p>
                            <p class="text-gray-700 text-sm">{{ $workOrder->scheduled_date?->format('d/m/Y') ?? '—' }}</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-3 p-3 bg-gray-50/70 rounded-xl border border-gray-100">
                        <span class="material-symbols-outlined text-gray-400 bg-white p-1.5 rounded-lg shadow-sm">flag</span>
                        <div>
                            ...
                            @endphp
                            <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium {{ $statusColors[$workOrder->status] ?? 'bg-red-50 text-red-700' }}">
                    ...
                    <div class="flex items-center gap-3 p-3 bg-blue-50/50 rounded-xl border border-blue-100 sm:col-span-2">
                        <span class="material-symbols-outlined text-blue-500 bg-white p-1.5 rounded-lg shadow-sm">schedule</span>
                        <div>
                            <p class="text-[10px] text-blue-400 uppercase tracking-wider font-medium">Tiempo trabajado</p>
                    ...
                    @endif
                    <div class="flex items-start gap-3 p-3 bg-gray-50/70 rounded-xl border border-gray-100 sm:col-span-2">
                        <span class="material-symbols-outlined text-gray-400 bg-white p-1.5 rounded-lg shadow-sm">sticky_note_2</span>
                        <div>
            ...
            <section>
                <div class="flex items-center gap-2 mb-3">
                    <span class="material-symbols-outlined text-teal-600 bg-teal-50 p-1 rounded-lg text-xl">inventory_2</span>
